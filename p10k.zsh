# Generated by Powerlevel10k configuration wizard on 2025-04-11 at 18:53 PDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    # Check for conflicts first (red *) or other changes (yellow *)
    if (( VCS_STATUS_NUM_CONFLICTED )); then
       # Show a red * for merge conflicts instead of ~N
       res+="${conflicted}*"
    elif (( VCS_STATUS_NUM_UNSTAGED || VCS_STATUS_NUM_UNTRACKED || VCS_STATUS_NUM_STAGED )); then
       # Show a yellow * for any kind of changes (staged, unstaged or untracked)
       res+="${modified}*"
    fi
...
typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl|kl'
